		...
		return async ({ result, update }) => {
			...
			if (result.type === 'failure') {
				...
				toast.success('Account has been successfully registered', {
					style: 'border-radius: 1rem; background: hsl(var(--su)); color: hsl(var(--suc));',
					position: 'top-right'
				});
				update();
			}
			...
			<div class="form-control m-2">
				<form method="POST" use:enhance={onFormSubmit} on:input={onFormInput}>
					...
					<CheckboxWithLabel
						...
						{isSubmitted}
					>
						<a href="#termsandconditions" on:click={termsModalOpen} class="font-bold underline">
...
<Modal bind:isShow={isTermsShow}>
	<h2 slot="header" class="mb-3">
		<h2 class="text-center"><b>TERMS AND CONDITIONS</b></h2>
	</h2>
	<div slot="body" class="my-3 text-left p-3 max-h-[70vh] overflow-y-auto border rounded">
		<p>1. <b>Introduction</b></p>
		<p>Welcome to <b>TestCompany</b> (“Company”, “we”, “our”, “us”)!</p>
		<p>
		...
		<p>
			...
			but please let us know by emailing at <b>testSupport@test.com</b> so we can try to find a solution.
		...
		<p>
			...
			Policy. If the rules for a Promotion conflict with these Terms of Service, Promotion rules
			will apply.
		</p>

		<p>4. <b>Content</b></p>
		<p>
			Content found on or through this Service are the property of TestCompany or used with
		...
		<p>
			...
			threatening, fraudulent, or harmful, or in connection with any unlawful, illegal, fraudulent,
		...
		<p>
			...
			functionality are and will remain the exclusive property of TestCompany and its licensors.
		...
		<p>
			...
			submit your claim via email to testSupport@test.com, with the subject line: “Copyright
		...
		<p>You can contact our Copyright Agent via email at testSupport@test.com.</p>
		<p>12. <b>Error Reporting and Feedback</b></p>
		<p>
			You may provide us either directly at testSupport@test.com or via third party sites and tools
			with information and feedback concerning errors, suggestions for improvements, ideas,
			problems, complaints, and other matters related to our Service (“Feedback”). You acknowledge
			and agree that: (i) you shall not retain, acquire or assert any intellectual property right or
			other right, title or interest in or to the Feedback; (ii) Company may have development ideas
			similar to the Feedback; (iii) Feedback does not contain confidential information or
			proprietary information from you or any third party; and (iv) Company is not under any
			...
			and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable,
		...
		<p>
			...
			controlled by TestCompany.
		</p>
		<p>
			TestCompany has no control over, and assumes no responsibility for the content, privacy
		...
		<p>
			For example, the outlined <a href="https://policymaker.io/terms-and-conditions/"
				>Terms of Use</a
			>
			...
			<a href="https://policymaker.io/terms-and-conditions/">Terms and Conditions generator</a> is an
		...
		<p>
			...
			NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THEIR
			SERVICES, OR THE INFORMATION, CONTENT OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY AGREE THAT
			YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS OBTAINED FROM US IS AT
			YOUR SOLE RISK.
		</p>
		<p>
			...
			THE SERVICES. WITHOUT LIMITING THE FOREGOING, NEITHER COMPANY NOR ANYONE ASSOCIATED WITH
			...
			DEFECTS WILL BE CORRECTED, THAT THE SERVICES OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF
		...
		<p>
			...
			ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT, INCLUDING WITHOUT LIMITATION ANY CLAIM
			FOR PERSONAL INJURY OR PROPERTY DAMAGE, ARISING FROM THIS AGREEMENT AND ANY VIOLATION BY YOU
			OF ANY FEDERAL, STATE, OR LOCAL LAWS, STATUTES, RULES, OR REGULATIONS, EVEN IF COMPANY HAS
			BEEN PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF
			THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE
			PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR PUNITIVE
		...
		<p>
			These Terms shall be governed and construed in accordance with the laws of Thailand, which
		...
		<p>
			...
			may restrict access to some parts of Service, or the entire Service, to users, including
			registered users.
		</p>
		...
		<p>
			...
			continuing waiver of such term or condition or a waiver of any other term or condition, and
		...
		<p>
			Please send your feedback, comments, requests for technical support by email: <b
				>testSupport@test.com</b
			>.
		</p>
		<p style="margin-top: 5em; font-size: 0.7em;">
			These <a href="https://policymaker.io/terms-and-conditions/">Terms of Service</a>
			were created for <b>TestWeb.com</b> by
			<a href="https://policymaker.io">PolicyMaker.io</a> on 2023-02-25.
		</p>
	</div>
	<div slot="footer" class="text-right mt-3">
		<button class="btn btn-sm" on:click={termsModalClose}>Close</button>
	</div>
</Modal>
